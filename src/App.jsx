...
function Model(props) {
  ...
  useFrame((state) => {
    ...
    if(!hovered){
      ...
      group.current.position.y=THREE.MathUtils.lerp(group.current.position.y, -1.22, 0.1)
  ...
  return (
    <group ref={group} {...props} dispose={null} rotation-z={-0.130} rotation-y={0.29} rotation-x={0.425}>
      <group rotation-x={-0.455} position={[0, -0.04, 0.41]}>
